...
namespace WebAppPatientTests.UnitTests
{
    public class SurveyTests
    {
        ...
        private static ISurveyRepository CreateSurveyStubRepository()
        {
            ...
            surveys.Add(new Survey(1, "Naslov ankete 1", "Komentar ankete 1", new DateTime(2020, 11, 6, 8, 30, 0), 1, null, new List<Question>()));
            surveys.Add(new Survey(2, "Naslov ankete 2", "Komentar ankete 2", new DateTime(2020, 11, 9, 9, 30, 0), 2, null, new List<Question>()));
            surveys.Add(new Survey(3, "Naslov ankete 3", "Komentar ankete 3", new DateTime(2020, 11, 11, 7, 30, 0), 3, null, new List<Question>()));
