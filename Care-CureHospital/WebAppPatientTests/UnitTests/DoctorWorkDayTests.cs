...
namespace WebAppPatientTests.UnitTests
{
    public class DoctorWorkDayTests
    {
        ...
        private static IDoctorWorkDayRepository CreateDoctorWorkDayStubRepository()
        {
            ...
            firstDoctorAppointments.Add(new Appointment(1, true, new DateTime(2020, 12, 5, 8, 0, 0), new DateTime(2020, 12, 5, 8, 30, 0)));
            ...
            secondDoctorAppointments.Add(new Appointment(4, false, new DateTime(2020, 12, 7, 15, 0, 0), new DateTime(2020, 12, 7, 15, 30, 0)));
            secondDoctorAppointments.Add(new Appointment(5, false, new DateTime(2020, 12, 7, 16, 0, 0), new DateTime(2020, 12, 7, 16, 30, 0)));
            ...
            doctorWorkDays.Add(new DoctorWorkDay(1, new DateTime(2020, 12, 5), 1, new Doctor { Id = 1, Name = "Marko", Surname = "Markovic", Specialitation = new Model.Doctor.Specialitation("Kardiolog") }, firstDoctorAppointments));
            doctorWorkDays.Add(new DoctorWorkDay(2, new DateTime(2020, 12, 7), 2, new Doctor { Id = 2, Name = "Pera", Surname = "Peric", Specialitation = new Model.Doctor.Specialitation("Lekar opste prakse") }, secondDoctorAppointments));
            doctorWorkDays.Add(new DoctorWorkDay(3, new DateTime(2020, 12, 6), 1, new Doctor { Id = 1, Name = "Marko", Surname = "Markovic", Specialitation = new Model.Doctor.Specialitation("Kardiolog") }, new List<Appointment>()));
            doctorWorkDays.Add(new DoctorWorkDay(4, new DateTime(2020, 12, 8), 1, new Doctor { Id = 1, Name = "Marko", Surname = "Markovic", Specialitation = new Model.Doctor.Specialitation("Kardiolog") }, new List<Appointment>()));
