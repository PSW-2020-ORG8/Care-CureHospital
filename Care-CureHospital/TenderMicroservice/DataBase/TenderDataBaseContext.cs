    ...
    public class TenderDataBaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Tender>().HasData(
                new Tender { Id = 1, MedicamentName = "Vitamin B", StartDate = new DateTime(2020, 1, 5, 8, 30, 0), EndDate = new DateTime(2020, 2, 5, 8, 30, 0), Active = true },
            ...
            modelBuilder.Entity<Offer>().HasData(
                new Offer { Id = 1, TenderId = 1, PharmacyName = "Jankovic", PharmacyEmail = "pharmacysistem@gmail.com", Price = 205.5, Quantity = 150, Comment = "Ova cena je za preko 100 komada!", ActiveTender = true },
                new Offer { Id = 2, TenderId = 1, PharmacyName = "Benu", PharmacyEmail = "benupharmacy@gmail.com", Price = 202.4, Quantity = 52, Comment = "Fiksna cena!", ActiveTender = true }
            );
        }
    }
}
